...
class DPOConfig(TrainingArguments):
    ...
    c1: float = field(
        default=0.8,
        metadata={
            "help": "c1 parameter from the [AOT](https://huggingface.co/papers/2406.05882) paper, which "
            "controls the weighting of the NLL term in the loss. The paper recommends `c1=0.8`."        
        },
    )
    c2: float = field(
        default=800,
        metadata={                                              
            ...
            "help": "c2 parameter from the [AOT](https://huggingface.co/papers/2406.05882) paper, which "
            "controls the weighting of the DPO term in the loss. The paper recommends `c                                2=800`."
        },
    )
